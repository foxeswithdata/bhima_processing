...
da_npp_aggregated = da_npp.sum(dim=["x", "y"]) * 817398.837317795 # kgC/m2/day -> kgC/day - assuming grid cell is 1kmx1km
...
filename = str("all_data_" + simulations + "_final.csv")

# print(out_put)
out_put.to_csv(filename)
# filename = str("npp_" + simulations + "_final.csv")
# print(out_put_npp)
# out_put_npp.to_csv(filename, index = True)