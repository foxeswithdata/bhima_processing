...
da_temp = xr.open_zarr(
            "data/temperature_K.zarr",
            consolidated=False
        )
da_vpd = xr.open_zarr(
            "data/vapour_pressure_deficit_kPa.zarr",
            consolidated = False
        )
da_ppfd = xr.open_zarr(
            "data/photosynthetic_photon_flux_density_W_m2.zarr",
            consolidated = False
        )
da_swp = xr.open_zarr(
            "data/soil_water_potential_MPa.zarr",
            consolidated=False
        )
da_nr = xr.open_zarr(
            'data/net_absorbed_radiation_vegetation_MJ_m2_day.zarr',
            consolidated=False
        )
